...
(function () {
  ...
  function installStyle() {
    ...
    style.id = STYLE_ID;
    style.textContent = `
      .guzman-header{position:sticky;top:0;z-index:1000;width:100%;background:rgba(20,15,30,.86);backdrop-filter:saturate(150%) blur(14px);-webkit-backdrop-filter:saturate(150%) blur(14px);border-bottom:1px solid rgba(255,255,255,.08);font-family:'Hanken Grotesk',system-ui,sans-serif;color:#fff}
